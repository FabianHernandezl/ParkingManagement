...
public class ClerksView extends JInternalFrame {
    ...
    public ClerksView() {
        ...
        txtEmployeeCode.setBounds(x + labelWidth + 10, y, fieldWidth, 25);
        ...
        txtSchedule.setBounds(x + labelWidth + 10, y, fieldWidth, 25);
        add(txtSchedule);
        y += verticalSpacing;
    ...
    private void loadParkingLots() {
        try {
            // Asumiendo que tienes un método para obtener todos los parking lots
    ...
    private void fillFormFromTable() {
        ...
        try {
            ...
            if (clerk != null) {
                ...
                txtSchedule.setText(clerk.getShedule());
